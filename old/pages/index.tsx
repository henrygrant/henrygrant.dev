  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="Henry Grant - Full Stack Software Developer"
        />
      ...
      <MainContainer>
        <InnerContainer>
          ...
          <Links>
            ...
            <a
              href="https://www.strava.com/athletes/1542509"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://www.instagram.com/henry_grant_/"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://www.twitter.com/henry_grant_/"
              target="_blank"
              rel="noreferrer"
            >
